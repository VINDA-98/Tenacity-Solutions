...
import (
	...
	email_response "github.com/VINDA-98/Tenacity-Solutions/server/plugin/email/model/response"
	"github.com/VINDA-98/Tenacity-Solutions/server/plugin/email/service"
