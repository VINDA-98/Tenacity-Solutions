...
import (
	...
	"errors"
	"fmt"
	ast2 "github.com/VINDA-98/Tenacity-Solutions/server/utils/ast"
	"io"
	"mime/multipart"
	"os"
	"path/filepath"
	...
	"github.com/VINDA-98/Tenacity-Solutions/server/resource/autocode_template/subcontract"
...
func Init(Package string) {
	...
	packageInjectionMap = map[string]astInjectionMeta{
		packageServiceName: {
			...
			importCodeF:  "github.com/VINDA-98/Tenacity-Solutions/server/%s/%s",
			packageNameF: "%s",
